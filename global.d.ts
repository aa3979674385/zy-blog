...
declare global {
  ...
  interface SearchRebuildWorkflowParams {}
  ...
  interface Env extends Cloudflare.Env {
    ...
    SEARCH_REBUILD_WORKFLOW: Workflow<SearchRebuildWorkflowParams>;
  ...
  // 每次构建唯一（vite.config.ts define 注入），用于 Worker Cache API 缓存版本校验
