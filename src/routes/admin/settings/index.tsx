...
import { WatermarkSection } from "@/features/config/components/watermark-section";
      ...
      >
        ...
        >
          ...
          <div className="flex-1 min-w-0 space-y-12 pt-2 lg:pt-0">
            ...
            <TabsContent value="watermark" className="mt-0 space-y-10">
              <div className="space-y-2 pb-6 border-b border-border/30">
                <h2 className="text-2xl font-serif font-medium tracking-tight">
                  图片水印
                </h2>
                <p className="text-sm text-muted-foreground">
                  为访客浏览的图片动态叠加水印，保护原创内容。
                </p>
              </div>
              <WatermarkSection />
            </TabsContent>
