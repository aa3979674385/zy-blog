                ...
                {item.children?.map((child) =>
                  child.external ? (
                    <a
                      ...
                      rel="noreferrer"
                      onClick={onClose}
                      className="flex items-center w-full pl-8 pr-4 py-2 text-sm font-medium rounded-lg transition-colors fuwari-text-50 hover:bg-(--fuwari-btn-regular-bg) hover:text-(--fuwari-primary) active:scale-[0.98]"
                    >
                      ↳ {child.label}
                    </a>
                  ) : (
