...
export function PostSummary({ summary }: PostSummaryProps) {
  ...
  return (
    <div
      className="mb-4 md:mb-6 rounded-2xl bg-(--fuwari-primary)/5 border border-black/5 dark:border-white/10 p-4 md:p-5 flex items-start gap-3 md:gap-4 transition-all hover:bg-(--fuwari-primary)/10 backdrop-blur-sm"
    >
