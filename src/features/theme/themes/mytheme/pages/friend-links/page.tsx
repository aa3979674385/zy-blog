...
export function FriendLinksPage({ links }: FriendLinksPageProps) {
  return (
    <div className="flex flex-col gap-4 w-full">
      ...
      <div
        className="fuwari-card-base p-6 md:p-8 relative overflow-hidden flex flex-col items-center justify-center min-h-56 bg-linear-to-br from-(--fuwari-primary)/5 to-transparent"
      >
        ...
        <Link
          to="/membership"
          className="mt-6 z-10 fuwari-btn-primary px-6 py-2.5 rounded-xl font-bold flex items-center gap-2 active:scale-95 transition-all"
        >
      ...
      {/* Links Grid */}
      <div
        className="fuwari-card-base p-6 md:p-8 flex-1"
      >
        {links.length > 0 ? (
