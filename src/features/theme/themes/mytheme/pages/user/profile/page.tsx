...
export function ProfilePage({
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-4xl mx-auto pb-12">
      ...
      <div
        className="fuwari-card-base p-8 md:p-10 relative overflow-hidden flex flex-col items-center justify-center bg-linear-to-br from-(--fuwari-primary)/5 to-transparent"
      >
        <div
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          <div
            className="fuwari-card-base p-6 md:p-8 flex flex-col gap-6"
          >
        ...
        <div className="flex flex-col gap-6">
          {notification.available && (
            <div
              className="fuwari-card-base p-6 flex flex-col gap-6"
            >
          ...
          <div
            className="fuwari-card-base p-6 flex flex-col gap-3"
          >
